...
N("Orb of Teleport", GEN_F, "Işınlanma Küresi", "Işınlanma Küreleri", "Işınlanma Küresini", "Işınlanma Küresiyle")
...
S("You activate the Flash spell!", "Işık büyüsünü etkinleştirdin!")
...
S("Could not open the score file: ", "Puan dosyası açılamadı: ")
...
S("You need an Orb of Teleport to teleport.", "Işınlanmak için Işınlanma Küresine ihtiyacın var.")
S("Use arrow keys to choose the teleport location.", "Işınlanacağın yeri seçmek için okları kullan.")
...
N("Flash Witch", GEN_F, "Işık Cadısı", "Işık Cadıları", "Işık Cadısını", "Işık Cadısıyla")
...
N("open gate", GEN_F, "açık kapı", "açık kapılar", "açık kapıyı", "açık kapıyla")
N("closing plate", GEN_F, "kapanan levha", "kapanan levhalar", "kapanan levhayı", "kapanan levhayla")
N("opening plate", GEN_F, "açılan levha", "açılan levhalar", "açılan levhayı", "açılan levhayla")
